                                    ...
                                    <div>
                                        <form className="flex-1 space-y-2 border border-black p-4 mb-2 rounded-md bg-white mt-4 lg:mt-0 text-balck">
                                            ...
                                            <div className="flex-1 border p-4 rounded-md space-y-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex space-x-2">
                                                            <div className="flex-1 relative">
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-credit-card absolute top-3 right-2" viewBox="0 0 16 16">
                                                ...
                                                {showCoupons && (
                                                    <div>
                                                        ...
                                                        <div className="flex space-x-2">
                                                            <div className="flex-1 relative">
                                                                <input className="p-2 w-full rounded-md border-2 border-gray-300 bg-gray-100 bg-gray-200" />
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tag absolute top-3 right-2" viewBox="0 0 16 16">
                                                ...
                                                {showLoyaltyPoints && (
                                                    <div>
                                                        <h2 className="text-sm  font-small">Loyalty points</h2>
                                                        <div className="flex space-x-2">
                                                            <div className="flex-1 relative">
                                                                <input className="p-2 w-full rounded-md border-2 border-gray-300 bg-gray-100 bg-gray-200" />
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill absolute top-3 right-2" viewBox="0 0 16 16">
                                                ...
                                                {showStoreCredits && (
                                                    <div>
                                                        <h2 className="text-sm  font-small">Store credits</h2>
                                                        <div className="flex space-x-2">
                                                            <div className="flex-1 relative">
                                                                <input className="p-2 w-full rounded-md border-2 border-gray-300 bg-gray-100 bg-gray-200" />
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-dollar absolute top-3 right-2" viewBox="0 0 16 16">
                                        ...
                                        <form className="flex-1 space-y-2 border p-4 rounded-md bg-white mt-4 lg:mt-0 text-balck">
                                            <label className="relative w-full flex flex-col">
                                                <input className="rounded-md peer pl-12 pr-2 py-2 border-2 border-gray-200 bg-gray-100 placeholder-gray-300" type="text" name="card_number" />
