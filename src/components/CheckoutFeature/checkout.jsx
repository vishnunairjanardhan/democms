...
const CheckoutPage = (walletData) => {
  ...
  const ProductValue1 = 55.00;
  const ProductValue2 = 45.00;
  ...
  const [storeCredits, setStoreCredits] = useState(30.00);
  const [appliedCoupons, setAppliedCoupons] = useState([]);
  const [displayCoupons, setDisplayCoupons] = useState(false)
  const giftCardDiscount = 15.00;
        ...
        <div className="lg:flex">
            ...
            <div className="p-4 bg-gray-100 h-full">
              ...
              <div className="md:w-full">
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  {displayCoupons && (
                    <div className="flex justify-between mb-2">
                      <span className="flex">Coupon SAVE10
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle m-1" viewBox="0 0 16 16" onClick={cancleAppliedCoupon}>
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg>
                      </span>
                      <span className=" ">-${appliedCoupons.reduce((acc, code) => {
                  ...
                  {giftCardRedeemed && (
                    <div className="flex justify-between mb-2">
                      <span className="flex  ">Gift Card 1234567890
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle m-1" viewBox="0 0 16 16" onClick={cancleGiftcard}>
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg>
                      </span>
                  ...
                  {loyaltyPointsRedeemed && (
                    <div className="flex justify-between mb-2">
                      <span className="flex  ">100 Loyalty Points
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle m-1" viewBox="0 0 16 16" onClick={cancleLoyaltyPoints}>
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg>
                      </span>
                  ...
                  {couponRedeemed && (
                    <div className="flex justify-between mb-2">
                      <span className="flex  ">Coupon 20OFF
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle m-1" viewBox="0 0 16 16" onClick={cancleCoupon}>
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg>
                      </span>
                  ...
                  {storeCreditsRedeemed && (
                    <div className="flex justify-between mb-2">
                      <span className="flex  ">Store Credits Discount
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle m-1" viewBox="0 0 16 16" onClick={cancleStoreCredits}>
                          <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                          <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                        </svg>
                      </span>
          ...
          <div className="lg:w-1/2 mt-4 lg:mt-0 flex flex-col flex-1">
            <div className="flex justify-between gap-8 fixed bottom-5 right-20 z-50 text-white">
              {walletData['walletData']['showCoupons'] && <div className="text-white relative">
                <button
                ...
                {isCouponOpen && (
                  <div className="flex flex-col absolute bottom-12 p-2 w-52 rounded-lg bg-vulcan-900" role="none">
                    <button
              ...
              {walletData['walletData']['showGiftCard'] && <div className="text-white relative">
                <button
                ...
                {isGiftCardOpen && (
                  <div className="absolute flex flex-col bottom-12 p-2 w-52 rounded-lg bg-vulcan-900" role="none">
                    <button
            ...
            <form method="post" className="flex-1 space-y-2 p-4 bg-white">
              ...
              <div className="flex-1 p-4 rounded-md space-y-1">
                ...
                {/* loyalty points */}
                {walletData['walletData']['showLoyaltyPoints'] && <div>
