...
const CouponGenerator = () => {
  ...
  >
      ...
      <h5 className="px-10 text-lg font-normal tracking-tight text-center h-16 text-white mb-6">{`Generate ${title} Codes`}</h5>
  ...
  return (
    ...
    <div className="container mx-auto flex flex-col items-center justify-center min-h-screen">
      <div className='relative mx-auto space-y-20'>
        ...
        <h1 class="mt-16 tracking-tight text-center text-white" data-aos="fade-down" data-aos-duration="1200">
        Free Coupon Code Generator
      </h1>
       <p class="mt-6 text-center text-vulcan-300" data-aos="fade-down" data-aos-duration="2000">
      ...
      <h2 className="text-2xl font-normal tracking-tight text-white mt-24 mb-4 text-center py-4" data-aos="fade-down" data-aos-duration="2000">Code Generation Form</h2>
