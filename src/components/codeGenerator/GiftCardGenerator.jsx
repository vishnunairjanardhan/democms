  ...
  return (
    ...
    <div className="container mx-auto flex flex-col items-center justify-center min-h-screen">
      <div className='relative mx-auto space-y-20'>
        ...
        <h1 data-aos="fade-down" data-aos-duration="2000" class="mt-16 tracking-tight text-center text-white">
        Free Gift Card Code Generator
      </h1>
       <p data-aos="fade-down" data-aos-duration="3000" class="mt-6 text-center text-vulcan-300">
      ...
      <h2 data-aos="fade-down" data-aos-duration="3000" className="text-2xl font-normal tracking-tight text-white mt-24 mb-4 text-center py-4">Code Generation Form</h2>
