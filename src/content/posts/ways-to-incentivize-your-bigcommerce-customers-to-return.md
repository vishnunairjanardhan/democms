...
Returning customers are gold, especially for an eCommerce store. According to the US Small Business Administration, an eCommerce store should spend 7-8% of its revenue on marketing. If there is one thing that can change the equation drastically in the store’s favor, it is to retain existing customers.
The average customer acquisition cost in eCommerce is somewhere around $45. The number varies based on the kind of products you sell. But these are significant digits, nevertheless. Imagine spending such an amount on each customer you acquire while letting the ones who are already there hop away.
...
Ensure that the rewards program is created so that your customers experience the first one as soon as possible. You can make it harder as they go up. Many customers drop off reward programs because earning them takes up a lot of time.
...
Here are a few ways you can use to make customers visit your site often:
<ul>
    <li>Would a weekly shopping guide be appealing?</li>
    <li>Will your customers be interested in a special hourly deal that happens once a week where they can grab products at a huge discount?</li>
    <li>You could have an engaging social media handle where you direct your followers to your site for a contest.</li>
    <li>How does a weekly giveaway sound? Or even a daily giveaway.</li>
    <li>Does the prospect of free samples interest them?</li>
</ul>    
...
Is it possible to make your eCommerce store that way? Let’s try.

Here are some of the things you should do on your BigCommerce store:
<ul>
    <li>Gamify the shopping experience.</li>
    <li>Give the opportunity to win free products.</li>
    <li>Offer free gift cards to customers based on certain trigger actions.</li>
    <li>Contests on the website and app are great ways to increase the visitor count.</li>
    <li>Build games that can be played on your store. Award prizes to winners.</li>
    <li>Create your community of users and host special “parties” for them.</li>
</ul>
...
Get in touch with your customers and ask them if you could be of assistance, especially the ones who haven’t purchased from you. It may or may not open a door for conversation. But it will help you stay on top of your customers’ minds.
...
For BigCommerce stores that want to incentivize their customers to return, you are in the right place. 99minds is a plug-and-play platform that helps you create coupons, discounts, and gift cards, send referrals, location-based promotions, and loyalty programs. It is exactly what you want if you want to superpower your customer retention efforts. Get in touch with us, and we will show you how exactly we can help you.